...
export type CompanyStatusEnum = 'Active' | 'Inactive' | 'Dissolved' | 'Bankrupt' | 'Pending' | 'Suspended';
export type CompanyTypeEnum = 'Other' | 'Sole Proprietorship' | 'Partnership' | 'Limited Liability Company (LLC)' | 'Corporation (C Corp)' | 'S Corporation' | 'Nonprofit Organization' | 'Cooperative (Co-op)';
